...
<h1 style="text-align: center;">Cuanto dinero quiere retirar</h1>
<p>&nbsp;</p>

<form action="contrasena.jsp" method="post">
<center>
	 <p>Valor a retirar <input type="text" name="Valor">
        <input type="submit" value="Continuar"style='width:100px; height:50px'></p>    
</center>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
